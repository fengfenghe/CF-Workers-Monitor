...
<body class="light-theme">
    ...
    <script>
        ...
        async function loadData(showAll) {
        ...
        function updateAccountDropdown() {
            ...
            ACCOUNTS_DATA.forEach(function(account, index) {
                ...
                summaryGrid.innerHTML = 
                    '<div class="summary-metric">' +
                        '<div class="metric-label">' +
                            '<img src="' + accountIcon + '" class="account-icon" /> Account 总数' +
                        '</div>' +
                        '<div class="summary-value">' + data.accounts.length + '</div>' +
                    '</div>' +
                    '<div class="summary-metric">' +
                        '<div class="metric-label">' +
                            '<img src="' + pageIcon + '" class="custom-icon" /> Pages 请求' +
                        '</div>' +
                        '<div class="summary-value">' + data.totals.formatted.pagesSum + '</div>' +
                    '</div>' +
                    '<div class="summary-metric">' +
                        '<div class="metric-label">' +
                            '<img src="' + workerIcon + '" class="custom-icon" /> Workers 请求' +
                        '</div>' +
